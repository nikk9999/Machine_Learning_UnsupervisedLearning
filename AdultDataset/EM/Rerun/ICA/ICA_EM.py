...
X_pca = FastICA(n_components=95).fit_transform(X)
...
ax.plot(comp, ll_tied1, label='tied ICA', color='c', linestyle=':')
ax.plot(comp, ll_spher1, label='spher ICA', color='m', linestyle=':')
ax.plot(comp, ll_diag1, label='diag ICA', color='g', linestyle=':')
ax.plot(comp, ll_full1, label='full ICA', color='y', linestyle=':')
