...
for n_clusters in range(1, 21):
    ...
    km1 = KMeans(n_clusters=n_clusters, init='k-means++', random_state=10).fit(X_pca)
...
ax.plot(nClusters, inertia1, label='Clustering after PCA')
...
plt.title("Adult PCA: K vs Sum of Squared Error")
plt.show()
