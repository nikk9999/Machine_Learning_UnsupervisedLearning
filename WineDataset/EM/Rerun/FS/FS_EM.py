...
ax.plot(comp, ll_tied1, label='tied FS', color='c', linestyle=':')
ax.plot(comp, ll_spher1, label='spher FS', color='m', linestyle=':')
ax.plot(comp, ll_diag1, label='diag FS', color='g', linestyle=':')
ax.plot(comp, ll_full1, label='full FS', color='y', linestyle=':')
