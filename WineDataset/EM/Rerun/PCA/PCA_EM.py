...
fig, ax = plt.subplots()
plt.title("Wine Quality Clustering EM")
...
ax.plot(comp, ll_tied1, label='tied PCA', color='c', linestyle=':')
ax.plot(comp, ll_spher1, label='spher PCA', color='m', linestyle=':')
ax.plot(comp, ll_diag1, label='diag PCA', color='g', linestyle=':')
ax.plot(comp, ll_full1, label='full PCA', color='y', linestyle=':')
